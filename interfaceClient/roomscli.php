...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="indexclient.html" class="btn"><span></span>HOME</a>
      ...
      <tbody class="tabel-content">
        ...
        ?>
          <tr>
            ...
            <td>
            <a href="../back-end/booked/boking.php?id_client=<?= $id_client?>&id_chambre=<?= $row['ID_Chambre']?>" class="link btn2"><span></span> Cancel </a>
            </td>
          </tr>
        <?php
        }
